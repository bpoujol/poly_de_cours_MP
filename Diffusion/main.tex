...
On peut distinguer trois grands types de transferts thermiques, qui sont représentés sur cette figure :

\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{modes_de_transfert.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.8\linewidth]{cristal_peu_conducteur.png}
...
\begin{proposition}
	Considérons un solide de capacité thermique massique à pression constante $c_p$, siège de transferts thermiques caractérisés par une densité de flux thermique $\vv{j_{th}}$. Le premier principe de la thermodynamique sous sa forme locale peut alors s'écrire :
	\begin{equation}
...
\begin{theorem}[Equation de diffusion thermique]
	Dans un solide de capacité thermique massique $c_p$, de conductivité thermique $\lambda$ et de masse volumique $\mu$ supposées uniformes, la température obéit à l'équation de diffusion thermique :
	\begin{equation}
