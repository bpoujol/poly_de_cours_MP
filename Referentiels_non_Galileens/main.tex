...
Les lois que nous connaissons en mécanique (principe d'inertie, principe fondamentale de la dynamique, théorème du moment cinétique, théorème de l'énergie cinétique) sont valables exclusivement dans des référentiels galiléens. Néanmoins, il est parfois utile d'étudier un mouvement dans un référentiel qui n'est pas galiléen, les lois usuelles de la mécanique ne semblent alors plus vérifées. C'est le cas par exemple dans un véhicule qui démarre, ou bien dans un référentiel en rotation. On observe alors des phénomènes qui peuvent paraître contre-intuitifs.
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.71\linewidth]{referentiel_copernic.png} \includegraphics[width=0.28\linewidth]{referentiel_terrestre.png}
...
\begin{definition}[Translation]
	...
	On parle de translation rectiligne lorsque le mouvement de $O_2$ est rectiligne dans $\
rrref_1$, et de translation rectiligne uniforme lorsque ce mouvement est rectiligne uniforme.
\end{definition}

\begin{definition}[Rotation]
	Un référentiel $\rref_2$ est dit en rotation par rapport au référentiel $\rref_1$ lorsqu'il existe un axe $(\Delta)$ de $\rref_2$ immobile dans le référentiel $\rref_1$, et que tous les points fixes dans $\rref_2$ ont un mouvement de rotation autour de l'axe $\Delta$ dans $\rref_1$.
...
\end{definition}
\begin{remark}
	Dans ce cours, nous nous limiterons exclusivement aux référentiels en translation et en rotation uniforme autour d'un axe fixe.
\end{remark}
...
\begin{theorem}[Relation de dérivation composée]
	...
	\begin{equation}
		\left. \frac{\dd \vv u}{\dd t} \right|_{\rref_1} = \left. \frac{\dd \vv u}{\dd t} \right|_{\rref_2} + \vv u \wedge \vv \Omega
	\end{equation}
\end{theorem}


\begin{figure}[htbp]
	\centering \includegraphics[width=0.75\linewidth]{rotation_reperes.png}
...
\begin{demonstration}
	...
	\begin{equation}
		\left. \frac{\dd \vv u}{\dd t} \right|_{\rref_2} = \dot u_x \vv{e_x} + \dot u_y \vv{e_y} + \dot u_z \vv{e_z} + u_x \Omega \vv{e_y} - u_y \Omega \vv{e_x}
	\end{equation}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.8\linewidth]{zerog.png}
...
\begin{proposition}[Composition des accélérations dans un référentiel en rotation]
	...
	\begin{equation}
		\vv a_(M/\rref_1) = \vv a_{\rm ent} + \vv a_{\rm rel} + \vv a_{\rm cor}
	\end{equation}
	où :
	\begin{itemize}
		...
		\item $\vv a_{\rm cor}$ est l'accélération de Coriolis, liée à la combinaison entre la vitesse de la particule dans le référentiel $\rref_2$ et la rotation de ce dernier :
			\begin{equation}
				\vv a_{\rm cor} = 2 \vv v(M/\rref_2) \wedge \vv \Omega = 2 \vv v_{\rm rel} \wedge \vv \Omega
			\end{equation}
	\end{itemize}
\end{proposition}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.75\linewidth]{coriolis.jpg}
...
\begin{encart}[La forme de la Terre]
	...
	\begin{itemize}
		\item D'une part, en raison de la rotation de la Terre, la pseudo-force d'inertie d'entraînement (centrifuge) est plus forte près de l'équateur et contribue donc à réduire l'éffet de l'attraction gravitationnelle de la Terre ;
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{forme_terre.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=\linewidth]{cyclone_schema.jpg} \includegraphics[width=0.7\linewidth]{tornade.jpg}
