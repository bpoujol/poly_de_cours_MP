...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.3\linewidth]{drude.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{schema_resistance.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{loi_des_noeuds.png}
...
\begin{equation}
	I_{\rm entrant}  = - \sum_i \vv{j_i} \cdot \vv{S_i} = - \oiint_\Sigma \vv j \cdot \vv{\dd S}
\end{equation}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{reflexion.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.6\linewidth]{effet_de_peau.jpeg}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{courant_surfacique.png}
...
\begin{encart}[Voiles solaires]
	La quantité de mouvement du champ électromagnétique peut être exploitée pour propulser des petits satellites à l'aide d'une voile solaire : un grande toile conductrice déployée face au soleil. Ce type de dispositif a été testé avec succès pour la première fois en 2010 par la JAXA (agence spatiale japonaise) et a depuis été repris par d'autres agences spatiales, mais reste encore au stade de prototype. Il permet d'éviter l'utilisation de panneaux solaires ou de carburants, relativement lourds et chers. La photo de couverture montre une vue d'artiste d'une voile solaire déployée en 2025 par la NASA.
\end{encart}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.6\linewidth]{cavite.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{modes_propres.png}
