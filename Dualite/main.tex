...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{loi_de_planck.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=\linewidth]{effet_photoelectrique.png}
...
\begin{figure}{htbp}
	\centering \includegraphics[width=0.8\linewidth]{Double_slit_Tonomura.jpg}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.49\linewidth]{Franck_Hertz_dispositif.png} \includegraphics[width=0.49\linewidth]{Franck_Hertz_mesures.png}
	\caption{Expérience de Franck et Hertz. A gauche : dispositif de mesure. A droite : résultats de l'expérience. L'intensité mesurée $i$ est proportionnelle au nombre et à la vitesse des électrons (nous avons vu en cours $\vv j = - n e \vv v$). Elle est tracée en fonction du posttentiel appliqué. Source : Froustey, Fillette et Roussille, \textit{Physique pour l'agrégation}.}
\end{figure}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{Puits_infini.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.9\linewidth]{puits_infini.png}
