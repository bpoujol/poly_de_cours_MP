...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.7\linewidth]{pression_altitude_macro.jpg} \includegraphics[width=0.25\linewidth]{pression_altitude_micro.png}
...
\begin{figure}[htbp]
	\centering \includegraphics[width=0.5\linewidth]{probas_deux_niveaux.png}
